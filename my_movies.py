...
a_team = movie_class.Movie("A-Team",
...
iron_man = movie_class.Movie("Iron Man",
...
sherlock_holmes = movie_class.Movie("Sherlock Holmes",
...
italian_job = movie_class.Movie("The Italian Job",
...
avengers = movie_class.Movie("The Avengers",
